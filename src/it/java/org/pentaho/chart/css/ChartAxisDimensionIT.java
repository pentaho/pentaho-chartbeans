...
public class ChartAxisDimensionIT extends TestCase {
  ...
  public void testChartAxisDimension() throws IllegalStateException, ResourceException {
    final ChartDocumentContext cdc = ChartFactory.generateChart(getClass().getResource("ChartAxisDimensionTest.xml")); //$NON-NLS-1$
