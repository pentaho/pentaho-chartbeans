...
public class ChartOrientationStyleIT extends TestCase {
  ...
  public void testOrientationStyle() throws Exception {
    final ChartDocumentContext cdc = ChartFactory.generateChart(getClass().getResource("ChartOrientationStyleTest.xml")); //$NON-NLS-1$
