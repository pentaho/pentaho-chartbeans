...
public class ChartMarkerVisibleIT extends TestCase {
  ...
  public void testMarkerVisible() throws IllegalStateException, ResourceException {
    ...
    final CSSConstant[] passValues = new CSSConstant[]{
        ChartMarkerVisibleType.HIDDEN,
        ChartMarkerVisibleType.HIDDEN,
        ChartMarkerVisibleType.VISIBLE,
        ChartMarkerVisibleType.HIDDEN,
        ChartMarkerVisibleType.HIDDEN,
        ChartMarkerVisibleType.HIDDEN,
    };
